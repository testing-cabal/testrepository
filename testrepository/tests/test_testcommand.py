...
class TestTestCommand(ResourcedTestCase):
    ...
    def test_get_run_command_no_config_file_errors(self):
        ui, command = self.get_test_ui_and_cmd()
        self.assertThat(
            command.get_run_command, raises(ValueError("No .testr.conf config file"))
        )
    ...
    def test_get_run_command_no_config_settings_errors(self):
        ...
        self.assertThat(
            ...
            raises(ValueError("No test_command option present in .testr.conf")),
        )
    ...
    def test_group_regex_option(self):
        ...
        fixture = self.useFixture(command.get_run_command())
        self.assertEqual("pkg.class.", fixture._group_callback("pkg.class.test_method"))
    ...
    def test_extra_args_passed_in(self):
        ...
        fixture = self.useFixture(command.get_run_command(testargs=("bar", "quux")))
            ...
            MatchesAny(
                Equals(
                    [
                        ...
                        (
                            "values",
                            [("running", "quux instances -- foo --list whoo yea")],
                        ),
                        (
                            "popen",
                ...
                Equals(
                    [
                        ...
                        (
                            "values",
                            [("running", "quux returned -- foo --list whoo yea")],
                        ),
                        (
                            "popen",
    ...
    def test_run_tests_list_file_in_FILES(self):
        ...
        self.assertEqual(
            [
                ...
                ("popen", (expected_cmd,), {"shell": True, "stdin": -1, "stdout": -1}),
            ],
            ui.outputs,
        )
        # No --parallel, so the one instance should have been allocated.
    ...
    def test_callout_concurrency_failed(self):
        ...
        fixture = self.useFixture(command.get_run_command())
        self.assertThat(
            lambda: fixture.callout_concurrency(),
            raises(ValueError("test_run_concurrency failed: exit code 1, stderr=''")),
        )
        self.assertEqual(
            [
                ("popen", ("probe",), {"shell": True, "stdin": -1, "stdout": -1}),
